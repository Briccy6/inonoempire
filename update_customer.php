                ...
                <form method="POST">
                  <div class="form-row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input id="phone" type="text" name="phone" class="form-control" value="<?php echo $cust->customer_phoneno; ?>">

                      <!-- <input type="text" name="customer_phoneno" value="" class="form-control" value=""> -->
                    </div>
                  </div>
                  <hr>
                  <div class="form-row">
